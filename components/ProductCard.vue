...
<template>
    <NuxtLink :to="`/products/${product.id}`" class="group relative flex flex-col justify-between overflow-hidden h-full">
        <button
        ...
        <img :alt="`Photo of ${product.title}`" :src="product.image"
